package com.example.pc_42.cobrotaxi;
...
public class MainActivity extends AppCompatActivity implements LocationListener {
       ...
       /* if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
        ...
        buttonDetener.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                textFin.setText("*LATITUD FINAL: " + latList.get( finListLat - 1) + "\n");
                textFin.append("*LONGITUD FINAL: " + longList.get( finListLon - 1 ));
                inicio = false;
                total += banderazo;
                DecimalFormat dosDecimales = new DecimalFormat("#.00");
                textTotal.setText("**TE TOCA PAGAR $ " + dosDecimales.format( total ) );
            }
        });
    }
    ...
    public void onProviderEnabled(String s) {
        textInicio.setText("**LISTO!! :)");
    }

    @Override
    public void onProviderDisabled(String s) {
        textInicio.setText("**ENCIENDE TU GPS!!");
